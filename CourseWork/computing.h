...
private:
	...
	long double precision_computing(const long double x, const long double t, const long double a, const long double A, const long double B, const long double C);
	long double approximate_computing(const long double w, const long double wleft, const long double wright, const long double r);
